...
Un fichier `md` (ou markdown) est le type de document le plus simple à éditer avec Vizboard.
...
Lorsque vous éditez un document en `md` avec Vizboard vous pouvez utiliser la syntaxe markdown comme vous le feriez habituellement, et ce que vous écrirez d'un côté apparaîtra mis en forme de l'autre... [WYSIWYG](https://en.wikipedia.org/wiki/WYSIWYG).
